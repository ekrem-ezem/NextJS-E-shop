        ...
        >
          <div className="text-uppercase my-3" style={{ maxWidth: "600px" }}>
            ...
            <div className="mt-4 text-secondary">
              ...
              <p>邮件: {order.user.email}</p>
              <p>地址: {order.address}</p>
              <p>电话号: {order.mobile}</p>
              ...
              {order.method && (
                <h6>
                  付款方式: <em>{order.method}</em>
                </h6>
              )}

              {order.paymentId && (
                <p>
                  订单号: <em>{order.paymentId}</em>
                </p>
              )}
          ...
          {!order.paid && auth.user.role !== "admin" && (
            <div className="p-4">
              <h2 className="mb-4 text-uppercase">总共: {order.total}€</h2>
